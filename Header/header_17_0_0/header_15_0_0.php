<?php 
    ...
    $path = $path.'/Module_v2/Header/header_15_0_0'; 
    if($check == 0){
        $css_inline .= "  
        <style>
            .header_15_0_0{
            ...
            .header_15_0_0_box1-td {
                padding-top: 5px;
            }

            .header_15_0_0_box1-td img {
                vertical-align: bottom;
                width: 100%;
            }
...
<header class="header_15_0_0">
            ...
            <div class="header_15_0_0_box1">
                ...
                <div class="header_15_0_0_box1-dv">
                    <div class="header_15_0_0_box1-call">
                        <a class="bvda_call">
                            <img src="<?php echo $path ?>/images/boxtop-call.png?ver=2">
                        </a>
                    </div>
                    <div class="header_15_0_0_box1-td">
                        <a href="https://tuyendung.benhvienthammydonga.vn/" target="_blank">
                            <img src="<?php echo $path ?>/images/tuyendung.png">
                        </a>
                    </div>
    ...
    <div class="container">
        <div class="header_15_0_0_box2" id="headerMenu">
            ...
            <div class="header_15_0_0_box2-td">
                <a href="https://tuyendung.benhvienthammydonga.vn/" target="_blank">Tuyển dụng</a>
            </div>
        </div>
    </div>
    <div class="header_15_0_0_box3"></div>
</header>
<?php get_template_part('Module_v2/Popup/popup_search_1_0_0/popup_search_1_0_0');?>
